""" This file classifies the entries into various datatypes """
...
def purestringFunction(entry, bdict):
    if adict['find_string'] and not adict['find_integer'] and not adict['find_empty'] and not adict['find_no_entry'] and not adict['find_dot'] and not adict['find_slash']:
        ...
        if not adict['find_email'] and not adict['find_http'] and not adict['find_caps'] and adict['find_string'] not in lower_states and adict['find_string'] not in upper_states:
            return "string without integer and without spaces"
        elif len(adict['find_caps']) == 1:
            if len(adict['find_string']) > 1:
                return "string with single caps with no integer or spaces"
            if len(adict['find_string']) == 1:
                return "string of unit length with single caps"
        elif len(adict['find_caps']) != len(adict['find_string']) and not adict['find_space']:
            return "string with capital letters but not state code nor pure uppercase"
...
def stringFunction(entry, bdict):
    if (adict['find_string'] and adict['find_integer'] and not adict['find_empty'] and not adict['find_http'] and not adict['find_no_entry'] and adict['find_dot'] and not adict['find_email']) or (adict['find_string'] and not adict['find_integer'] and not adict['find_empty'] and adict['find_dot'] and not adict['find_email'] and not adict['find_website'] and not adict['find_http']):
        ...
        return "string with dot but not email"
        ...
        return "string with @ instead of at"
...
def pureStringWithSpacesFunction(entry, bdict):
    if (adict['find_space'])and(len(adict['find_string']) + len(adict['find_space']) == len(entry)):
        ...
        return "string with spaces but no integer"
...
def websiteFunction(entry, bdict):
    if (adict['find_string'] and adict['find_http'] and adict['find_slash'] and adict['find_dot']) or (adict['find_string'] and adict['find_http'] and adict['find_slash'] and adict['find_dot'] and adict['find_integer']):
        ...
        return "possible website with http and slash"
    ...
    if adict['find_string'] and adict['find_dot'] and not adict['find_website'] and adict['find_word_after_dot'] and not adict['find_space'] and not adict['find_email'] and not adict['find_hashtag'] and not adict['find_comma'] and (len(adict['find_string']) > 5):
        ...
        if not adict['find_email'] and not adict['find_slash'] and len(adict['find_dot']) <= 1:
            if(len(entry)-x[0] > 4):
                ...
                string_with_dots_not_email_not_website += 1
                bdict['string_with_dots_not_email_not_website'] = string_with_dots_not_email_not_website
                return "string with one dot but one website"
            else:
                website_without_www += 1
                bdict['website_without_www'] = website_without_www
...
def emailFunction(entry, email_array, bdict):
    if adict['find_string'] and adict['find_dot'] and adict['find_integer'] and adict['find_email'] and not adict['find_empty'] and not adict['find_no_entry'] and (len(adict['find_at_the_rate']) == 1):
        global email_with_integer
        email_with_integer += 1
        bdict['email_with_integer'] = email_with_integer
        email_array.append(entry)
    elif adict['find_string'] and adict['find_email'] and adict['find_dot'] and not adict['find_empty'] and not adict['find_integer'] and not adict['find_no_entry'] and (len(adict['find_at_the_rate']) == 1):
        global email_without_integer
        email_without_integer += 1
        bdict['email_without_integer'] = email_without_integer
        email_array.append(entry)
    if (adict['find_string'] and adict['find_dot'] and adict['find_integer'] and adict['find_email'] and not adict['find_empty'] and not adict['find_no_entry'] and (len(adict['find_at_the_rate']) > 1)) or (adict['find_string'] and adict['find_email'] and adict['find_dot'] and not adict['find_empty'] and not adict['find_integer'] and not adict['find_no_entry'] and (len(adict['find_at_the_rate']) > 1)):
        email_array.append('multiple @')
    return email_array
...
def phoneFunction(entry, bdict):
    if adict['find_string'] and adict['find_phone'] and not adict['find_slash'] and adict['find_integer'] and not adict['find_dot'] and len(adict['find_integer']) >= 6:
        ...
        return "possible phone no but with alphabets"
    if len(adict['find_phone']) == 1 and len(adict['find_integer']) == 10 and not adict['find_successive_hyphens'] and len(adict['find_integer']) > len(adict['find_string']) and adict['find_slash']:
        ...
        return "possible phone no but with slash instead of one of the hyphens"
    if len(adict['find_phone']) == 1 and len(adict['find_integer']) < 10 and not adict['find_successive_hyphens'] and len(adict['find_integer']) > len(adict['find_string']) and adict['find_slash']:
    ...
    if len(adict['find_phone']) == 1 and len(adict['find_integer']) == 10 and not adict['find_string'] and not adict['find_hashtag'] and adict['find_pattern_phone_parantheses']:
        if adict['find_phone_three_parts_one_hyphen_one_parantheses'] and not adict['find_string']:
            ...
            return "phone no with three parts with one hyphen and a parantheseses"
        else:
            ...
            if open_brace and not close_brace:
                ...
                return "phone no with only open parantheses"
            if close_brace and not open_brace:
                ...
                return "phone no with only close parantheses"
    if adict['find_pattern_phone_parantheses'] and not adict['find_website'] and not adict['find_string'] and len(adict['find_integer']) == 10 and not adict['find_pattern_phone_10_digits'] and not adict['find_phone_three_parts_two_hyphens'] and not adict['find_phone_three_parts_one_hyphen_one_parantheses'] and not adict['find_pattern_phone_three_parts_plus_one'] and not adict['find_pattern_phone_11_digits']:
        ...
        return "phone no with parantheses"
...
def zipcodeFunction(entry, bdict):
    ...
    if adict['find_integer'] and adict['find_phone'] and adict['find_zipcode_one_hyphen'] and single_hyphen_split[0] in zipcodes:
        ...
        bdict['mostly_zipcode_with_one_hyphen'] = mostly_zipcode_with_one_hyphen
        return "Most probably a zipcode with one hyphen"
    if adict['find_integer'] and adict['find_phone']:
        global pure_integer
        pure_integer += 1
        bdict['pure_integer'] = pure_integer
        if adict['find_zipcode_one_hyphen'] and single_hyphen_split[0] not in zipcodes:
            return "has one hyphen but is not a zipcode"
        if adict['find_zipcode_two_hyphen'] and double_hyphen_split[0] not in zipcodes:
            return "has two hyphen but is not a zipcode"
    if adict['find_integer'] and adict['find_phone'] and double_hyphen_split[0] in zipcodes:
        ...
        return "Most probably a zipcode with two hyphen"
    if len(adict['find_phone']) == 2 and len(adict['find_integer']) != 10 and not adict['find_successive_hyphens'] and not adict['find_string'] and len(single_hyphen_split[0]) > 3 and single_hyphen_split[0] in zipcodes:
        ...
        return "possible zip codes but with two but not succesive hyphens"
    if len(adict['find_phone']) == 2 and len(adict['find_integer']) != 10 and not adict['find_successive_hyphens'] and not adict['find_string']:
        ...
        if len(single_hyphen_split[0]) > 3 and single_hyphen_split[0] not in zipcodes:
            return "integer with two hyphens but not zipcode or phone"
        if len(single_hyphen_split[0]) <= 3:
            return "integers separated by hyphen but not zipcode or phone number"
...
def integerFunction(entry, bdict):
    ...
    if adict['find_string'] and not adict['find_space'] and adict['find_integer'] and not adict['find_email'] and not adict['find_website'] and not adict['find_dot'] and not adict['find_phone']:
        ...
        return "string with integer without spaces"
    if adict['find_string'] and adict['find_space'] and adict['find_integer'] and not adict['find_email'] and not adict['find_website'] and not adict['find_dot'] and not adict['find_phone']:
        ...
        return "string with integer and spaces"
    if adict['find_string'] and adict['find_phone'] and adict['find_integer'] and not adict['find_dot'] and len(adict['find_integer']) < 6:
        global string_with_integer_hyphen
        string_with_integer_hyphen += 1
        bdict['string_with_integer_hyphen'] = string_with_integer_hyphen
        if adict['find_space']:
            return "Mixture of string integer and hyphen and spaces"
        if not adict['find_space']:
            return "Mixture of string integer and hyphen but not spaces"
    if adict['find_integer'] and not adict['find_phone'] and (adict['find_zipcode_without_hyphen']):
        if entry in zipcodes:
            ...
            return "most probably a zipcode (without hyphen)"
        else:
            global pure_integer
            pure_integer += 1
            bdict['pure_integer'] = pure_integer
            zipcode_array.append(entry)
            return "not a Zipcode"
    if adict['find_integer'] and not adict['find_phone'] and (adict['find_zipcode_four_digits']):
        ...
        if c in zipcodes:
            ...
            return "most probably a zipcode (four digits)"
        else:
            pure_integer += 1
            bdict['pure_integer'] = pure_integer
    ...
    if adict['find_integer'] and not adict['find_phone'] and adict['find_pattern_phone_11_digits'] and not adict['find_string']:
        ...
        return "11 digit phone no i.e starts with 1 followed by 10 digits"
    if adict['find_integer'] and adict['find_phone']and not adict['find_string']and entry[0] == "-":
        decimal_integer += 1
        bdict['decimal_integer'] = decimal_integer
        decimal_integer_lengths.append(len(adict['find_dot']))
        if adict['find_decimal']:
            return "Negative integer with decimals"
        if adict['find_dot'] and not adict['find_decimal']:
            return "decimal integer with misplaced dot"
        if not adict['find_dot'] and not adict['find_special_characters']:
            return "Negative integer without decimals"
        if not adict['find_decimal'] and adict['find_special_characters']:
            return "Negative integer with special characters"
    if adict['find_integer'] and not adict['find_phone'] and not adict['find_zipcode_without_hyphen'] and not adict['find_zipcode_four_digits'] and not adict['find_string'] and not adict['find_dot'] and not adict['find_pattern_phone_10_digits'] and not adict['find_phone_three_parts_two_hyphens'] and not adict['find_phone_three_parts_one_hyphen_one_parantheses'] and not adict['find_pattern_phone_three_parts_plus_one'] and not adict['find_special_characters'] and not adict['find_email']:
        pure_integer += 1
        bdict['pure_integer'] = pure_integer
        if not adict['find_pattern_phone_11_digits']:
            return "Pure integer"
    if adict['find_integer'] and adict['find_special_characters'] and (len(adict['find_integer'])+len(adict['find_special_characters']) == len(entry)):
        ...
        return "integer with special characters"
...
def stateCodeFunction(entry, bdict):
    ...
    if not adict['find_integer'] and not adict['find_empty'] and not adict['find_dot'] and not adict['find_no_entry'] and not adict['find_slash']:
        if len(adict['find_small']) and len((adict['find_string'])) == 2 and matching_lower:
            global state_code
            state_code += 1
            bdict['state_code'] = state_code
            return "possible state code in lowercase"
        if len(adict['find_caps']) and len((adict['find_string'])) == 2 and matching:
            state_code += 1
            bdict['state_code'] = state_code
            return "possible state code"

    if len(adict['find_string']) > 2 and not adict['find_integer'] and not adict['find_empty'] and not adict['find_dot'] and not adict['find_no_entry'] and not adict['find_slash'] and not matching_lower and not adict['find_special_characters']:
        if len(adict['find_small']) == len(adict['find_string'])and len(adict['find_small']) > 2 and not matching_lower:
            global string_without_integer_without_spaces
            string_without_integer_without_spaces += 1
            bdict['string_without_integer_without_spaces'] = string_without_integer_without_spaces
            return "is not a state code just string in lowercase"
        if len(adict['find_caps']) == len(adict['find_string'])and len(adict['find_caps']) > 2 and not matching_upper:
            string_without_integer_without_spaces += 1
            bdict['string_without_integer_without_spaces'] = string_without_integer_without_spaces
            return "is not a state code just string in uppercase"

    if not adict['find_integer'] and not adict['find_empty'] and not adict['find_no_entry']and not adict['find_dot'] and not adict['find_slash'] and not matching:
        if len(adict['find_caps']) and len((adict['find_string'])) == 2 and not matching_upper:
            ...
            return "two lettered uppercase string not state code"
        if len(adict['find_small']) and len((adict['find_string'])) == 2 and not matching_lower:
            ...
            return "two lettered lowercase string not state code"

    if len((adict['find_string'])) > 2 and not adict['find_integer'] and not adict['find_empty'] and not adict['find_dot'] and not adict['find_no_entry'] and not adict['find_slash']:
        if len(adict['find_small']) == len(adict['find_string']) and matching_lower:
            state_code += 1
            bdict['state_code'] = state_code
            return "possible state name in lowercase"
        if len(adict['find_caps']) == len(adict['find_string']) and matching_upper:
            state_code += 1
            bdict['state_code'] = state_code
            return "possible state name in capital letters"
...
def datatypeClassifier(entry, email_array, bdict):
    ...
    stringWithSpecialCharactersFunction(entry, bdict)
    websiteFunction(entry, bdict)
    websiteWithoutWWWFunction(entry, bdict)
    emailFunction(entry, email_array, bdict)
...
def bdictFunction():
    bdict[' valid_verified_zipcode_without_hyphen'] = \
    bdict['valid_verified_zipcode_with_two_hyphen'] = \
    bdict['zipcode_with_two_not_successive_hyphens'] = \
    bdict['valid_verified_zipcode_with_one_hyphen'] = \
    bdict['mostly_zipcode_with_one_hyphen'] = \
    bdict['mostly_zipcode_without_hyphen'] = \
    bdict['mostly_zipcode_with_two_hyphen'] = bdict['mostly_zipcode_four_digits'] \
    = bdict['phone_no_two_hyphens'] = bdict['phone_no_without_hyphen_or_alphabets']\
    = bdict['phone_no_with_alphabets'] = bdict['phone_three_parts_two_hyphens']= \
    bdict['phone_three_parts_one_hyphen_one_parantheses'] = \
    bdict['phone_three_parts_plus_one'] = bdict['phone_10_digits'] = \
    bdict['phone_no_with_parantheses'] = bdict['phone_no_one_hyphen'] = \
    bdict['phone_no_with_only_open_parantheses'] = \
    bdict['phone_no_with_only_close_parantheses'] = \
    bdict['string_with_integer_spaces'] = bdict['string_with_integer_hyphen']=\
    bdict['string_with_symbol_instead_of_at'] = bdict['string_first_line_address']\
    = bdict['string_with_dots_not_email_not_website'] =\
    bdict['two_letter_lowercase_string_not_state_code'] = \
    bdict['string_with_integer_without_spaces'] = bdict['website'] = \
    bdict['website_without_www'] = bdict['string_without_integer_without_spaces'] = \
    bdict['string_with_space_no_integer'] = bdict['pure_uppercase_string'] = \
    bdict['two_letter_uppercase_string_not_state_code'] = bdict['state_code']=\
    bdict['string_with_special_characters'] = bdict['integer_with_special_characters']=\
    bdict['email_with_integer'] = bdict['email_without_integer'] = \
    bdict['decimal_integer'] = bdict['integer_with_at'] = bdict['pure_integer']\
    = bdict['pureStringWithSpaces'] = 0
    return bdict
