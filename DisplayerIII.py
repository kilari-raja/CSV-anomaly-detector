...
def print_special_characters_phone(filesname,start,end,datum,print_array):  
    ...
    for i in range(1,len(datum)):       
        ...
        if find_special_characters_phone :
            defective_rows += 1
            funct_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,func_count,i,27,print_array)    
    return print_array
...
def print_symbols(filesname,start,end,datum,print_array):
    ...
    for i in range(1,len(datum)):       
        ...
        if find_integer and find_at_the_rate and not find_dot :
            defective_rows += 1
            funct_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,func_count,i,40,print_array)
...
def print_email_without_dot(filesname,start,end,datum,print_array): 
    ...
    for i in range(1,len(datum)):   
        ...
        if find_email and not find_dot :
            defective_rows += 1
            funct_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,func_count,i,38,print_array)    
    return print_array                  
