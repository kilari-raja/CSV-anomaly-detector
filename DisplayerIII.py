...
def print_uppercase_entries(filesname,start,end,datum):	
	defective_rows = row_no_in_original_file = print_count =0
	for i in range(1,len(datum)):		
		find_uppercase = re.findall(pattern_uppercase,datum[i][start])
		row_no_in_original_file += 1
		if find_uppercase :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,32)
	#return func_count
def print_empty_entries(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):
		...
		if find_empty or find_no_entry :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,7)
	#return func_count
def print_string_entries(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):		
		...
		row_no_in_original_file += 1
		if find_string :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,29)			
	#return func_count
def print_string_without_hyphen_entries(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):		
		...
		if find_string and not find_phone :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,30)				
	#return func_count
def print_string_only_entries(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):
		...
		if find_string and len(find_string) == len(datum[i][start]) :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,24)			
	#return func_count	
def print_string_with_integer_and_space_entries(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):
		...
		if find_string and find_integer and find_space :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,31)			
	#return func_count	
def print_integer_entries(filesname,start,end,datum):		        
	...
	for i in range(1,len(datum)):		
		...
		if find_integer and len(find_integer)!=len(datum[i][start]):
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,12)			
	#return func_count	
def print_integer_only_entries(filesname,start,end,datum):		
	...
	for i in range(1,len(datum)):		
		...
		if find_integer and not find_string and len(find_integer)==len(datum[i][start]) :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,14)					
	#return func_count	
def print_improper_decimal_integers(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):		
		...
		if find_integer and not find_string and len(decimal_integer_lengths) > 0  and len(find_dot) != counter_decimal_integer.most_common(1)[0][0]:
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,10)			
	#return func_count
def improper_integer_entries(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):
		...
		if len(find_phone) == 1 and len(find_integer) != 10 and not find_string and not find_hashtag and not find_pattern_phone_parantheses and not find_slash :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,11)			
	#return func_count	
def print_email_entries(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):		
		...
		if find_email and find_dot and not find_space :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,5)			
	#return func_count
def print_website_entries(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):		
		...
		if find_website and find_dot:
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,35)			
	#return func_count	
def print_special_characters(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):
		...
		if find_special_characters :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,26)			
	#return func_count	
def print_special_characters_phone(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):		
		...
		if find_special_characters_phone :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,27)			
	#return func_count	
def print_special_characters_website(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):		
		...
		if find_special_characters_website :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,28)			
	#return func_count	
def print_hyphen(filesname,start,end,datum):		
	...
	for i in range(1,len(datum)):			
		...
		row_no_in_original_file += 1
		if find_phone :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,9)			
	#return func_count	
def print_space_entries(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):		
		...
		if (find_string and find_space) or (find_integer and find_space):
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,25)			
	#return func_count	
def print_no_dots(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):		
		...
		if (find_string and not find_dot) :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,20)			
	#return func_count
def print_pure_integer_not_zipcode(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):		
		...
		if find_integer and not find_phone and not find_zipcode_without_hyphen and not find_zipcode_four_digits and not find_string and not find_dot:
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,13)								
	#return func_count
def print_integer_more_than_string(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):		
		...
		if (len(find_integer) > len(find_string) and not find_website) :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,16)
	#return func_count
def print_string_more_than_integer(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):		
		...
		if (len(find_string) > len(find_integer)) :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,17)
	#return func_count
def print_not_state_code(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):		
		...
		if (datum[i][start] not in states) or (datum[i][start] not in lower_states) or (datum[i][start] not in upper_states) or (datum[i][start] != " ") or (datum[i][start] != "") :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,19)
	#return func_count
...
def print_string_with_symbol_at_but_not_email (filesname,start,end,datum):		
	...
	for i in range(1,len(datum)):		
		...
		if find_string and find_at_the_rate and not find_dot :			
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,37)
	#return func_count
def print_string_with_hashtag_without_space (filesname,start,end,datum):		
	...
	for i in range(1,len(datum)):		
		...
		if find_string and find_hashtag and not find_space :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,1)
	#return func_count	
def print_integer_with_hashtag_without_space (filesname,start,end,datum):					
	...
	for i in range(1,len(datum)):		
		...
		if find_integer and find_hashtag and not find_space :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,0)			
	#return func_count
def print_string_with_parantheses (filesname,start,end,datum):		
	...
	for i in range(1,len(datum)):		
		...
		if (find_string and find_open_parantheses) or (find_string and find_close_paranthses):
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,22)
	#return func_count
def print_integer_with_symbol_at_but_not_email (filesname,start,end,datum):		
	...
	for i in range(1,len(datum)):		
		...
		if find_integer and find_at_the_rate and not find_dot :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,40)
	#return func_count	
def print_integer_with_symbol_at_and_dot (filesname,start,end,datum):		
	...
	for i in range(1,len(datum)):
		...
		if find_integer and find_at_the_rate and find_dot and not find_string:
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,39)
	#return func_count			
def print_integer_with_parantheses  (filesname,start,end,datum):		
	...
	for i in range(1,len(datum)):		
		...
		if (find_integer and find_open_parantheses) or (find_integer and find_close_paranthses):
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,15)	
	#return func_count
def print_decimal_values(filesname,start,end,datum):		
	...
	for i in range(1,len(datum)):		
		...
		if find_integer and not find_zipcode_without_hyphen and not find_zipcode_four_digits and not find_string and find_dot:
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,2)				
	#return func_count
	...
	for i in range(1,len(datum)):		
		...
		if (datum[i][start] in state_code_array) and (datum[i][start] not in states_and_cities) :	
			for j in range(i+1,len(row)):
				...
				if key[0] == key[1] :
					func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,33)					
		else : 
			pass
	#return func_count
def print_state_code_lowercase(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):
		...
		if (datum[i][start].upper() in state_code_array) and find_lowercase:
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,34)				
		else : 
			pass
	#return func_count
		...
		if len(find_phone) == 1 and len(find_integer) < 10 and not find_string and not find_hashtag and not find_pattern_phone_parantheses and not find_slash and not find_space  :
					...
					if(len(y)>3):
						for k in range(0,len(you)-1):
							if zipcodes[j+3] == row[you[k]]:
								func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,36)			
				else :
					pass
				...
				if datum[i][start] == zipcodes[j] :					
					for k in range(0,len(datum[i])-1):
						if zipcodes[j+3] == datum[i][k]:
							func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,23)			
				else :
					pass
			...
			for j in range(0,len(zipcodes)-1):
				if c == zipcodes[j] :
					for k in range(0,len(you)-1):
						if zipcodes[j+3] == row[you[k]]:
							func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,8)			
				else: 
					pass
		else : 
			pass										
	...
	if len(duplicate_emails) > 0 :
		...
		for x in range(0,len(duplicate_emails))	:
			if duplicate_emails[x] in str(row) :
				func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,4)
	#return func_count
...
def print_email_with_more_than_one_at(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):
		...
		if len(find_at_the_rate) >=2 :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,18)
	#return func_count
def print_email_with_space(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):	
		...
		if find_string and find_email and find_dot and find_space :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,6)
	#return func_count
def print_email_without_dot(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):	
		...
		if find_email and not find_dot :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,38)
	#return func_count					
def print_string_without_email(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):		
		...
		if find_string and not find_email :
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,21)
	#return func_count	
def print_string_with_dots_not_email_not_website(filesname,start,end,datum):	
	...
	for i in range(1,len(datum)):	
		...
		if (find_string and find_integer and not find_empty and not find_no_entry  and find_dot and not find_email and not find_website) or (find_string and not find_integer and not find_empty and find_dot and not find_email and not find_website and not find_no_entry):
			func_count = print_in_improperTxt(datum,start,defective_rows,row_no_in_original_file,print_count,i,3)
	#return func_count