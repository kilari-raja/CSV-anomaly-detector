...
class TestFunctions(unittest.TestCase):
	...
	def test_website(self):
		...
		self.assertEqual(websiteFunction("www.rajkumar.com",bdict),'is possible website')
		regular_expressions("www.rr.com")
		self.assertEqual(websiteFunction("www.rr.com",bdict),'is possible website')
		...
		self.assertEqual(websiteFunction("http://www.rajkumar.com",bdict),'is possible website with http and slash')
		regular_expressions("rajkumar.co.in")
		self.assertEqual(websiteWithoutWWWFunction("rajkumar.co.in",bdict),'is possible website but without www (2 dot) and without slashes')
		regular_expressions("rajkumar.com")
		self.assertEqual(websiteWithoutWWWFunction("rajkumar.com",bdict),'is possible website but without www (1 dot)')
		regular_expressions("raj.k.mar")
		self.assertEqual(websiteWithoutWWWFunction("raj.k.mar",bdict),'is string with more than one dot but not website')		
	...
	def test_string(self):
		...
		self.assertEqual(purestringFunction("rajkumar",bdict),'is string without integer and without spaces')
		regular_expressions("rAjkumar")
		self.assertEqual(purestringFunction("Rajkumar",bdict),'is string with single caps with no integer or spaces')
		regular_expressions("R")
		self.assertEqual(purestringFunction("R",bdict),'is string of unit length with single caps')
		regular_expressions("RAJKUMAR")
		self.assertEqual(purestringFunction("RAJKUMAR",bdict),'is pure uppercase string with more than 2 characters')
		regular_expressions("rAjkuMar")
		self.assertEqual(purestringFunction("rAjkuMar",bdict),'is string with capital letters but not state code nor pure uppercase')
		regular_expressions("Raj.kumar")
		self.assertEqual(stringFunction("Raj.kumar",bdict),'is string with dot but not email')
		regular_expressions("raj.kumar")
		self.assertEqual(stringFunction("raj.kumar",bdict),'is string with dot but not email')  #full lowercase
		regular_expressions("Raj@kumar")
		self.assertEqual(stringFunction("Raj@kumar",bdict),'is string with @ instead of at')
		regular_expressions("raj@kumar")
		self.assertEqual(stringFunction("raj@kumar",bdict),'is string with @ instead of at')  #full lowercase
		regular_expressions("Raj kumar")
		self.assertEqual(pureStringWithSpacesFunction("Raj kumar",bdict),'is a pure string with spaces')
		regular_expressions("raj kumar")
		self.assertEqual(pureStringWithSpacesFunction("raj kumar",bdict),'is a pure string with spaces')
		regular_expressions("RAJ KUMAR")
		self.assertEqual(pureStringWithSpacesFunction("RAJ KUMAR",bdict),'is a pure string with spaces')
		regular_expressions("Raj/kumar")
		self.assertEqual(stringWithSpecialCharactersFunction("Raj/kumar",bdict),'is string with special characters')
		regular_expressions("Raj[kumar")
		self.assertEqual(stringWithSpecialCharactersFunction("Raj[kumar",bdict),'is string with special characters')
		regular_expressions("Raj!kumar")
		self.assertEqual(stringWithSpecialCharactersFunction("Raj!kumar",bdict),'is string with special characters')
		...
		self.assertEqual(stringWithSpecialCharactersFunction("Raj_kumar",bdict),'is string with special characters')
		regular_expressions("Raj\kumar")
		self.assertEqual(stringWithSpecialCharactersFunction("Raj\kumar",bdict),'is string with special characters')
		regular_expressions("Raj=kumar")
		self.assertEqual(stringWithSpecialCharactersFunction("Raj=kumar",bdict),'is string with special characters')
	...
	def test_phone(self):
		...
		self.assertEqual(phoneFunction("1800-AMY-4567",bdict),'is possible phone no but with alphabets')
		regular_expressions("180/458-4567")
		self.assertEqual(phoneFunction("180/458-4567",bdict),'is possible phone no but with slash instead of one of the hyphens')
		regular_expressions("180-874/4567")
		self.assertEqual(phoneFunction("180-874/4567",bdict),'is possible phone no but with slash instead of one of the hyphens')
		...
		self.assertEqual(phoneFunction("(180)1254567",bdict),'is phone no with parantheses')
		regular_expressions("180-254-5607")
		self.assertEqual(phoneFunction("180-254-5607",bdict),'is phone with two hyphens')
		regular_expressions("(180) 254-5607")
		self.assertEqual(phoneFunction("(180) 254-5607",bdict),'is phone no with three parts with one hyphen and a parantheseses')
		regular_expressions("(180 254-5607")
		self.assertEqual(phoneFunction("(180 254-5607",bdict),'is phone no with only open parantheses')
		regular_expressions("180) 254-5607")
		self.assertEqual(phoneFunction("180) 254-5607",bdict),'is phone no with only close parantheses')
	...
	def test_zipcode(self):
		...
		self.assertEqual(zipcodeFunction("83025-4567",bdict),'is Most probably a zipcode with one hyphen')
		regular_expressions("82999-4567")
		self.assertEqual(zipcodeFunction("82999-4567",bdict),'has one hyphen but is not a zipcode')
		regular_expressions("83025--4567")
		self.assertEqual(zipcodeFunction("83025--4567",bdict),'is Most probably a zipcode with two hyphen')
		regular_expressions("82999--4567")
		self.assertEqual(zipcodeFunction("82999--4567",bdict),'has two hyphen but is not a zipcode')
		regular_expressions("83025-456-7")
		self.assertEqual(zipcodeFunction("83025-456-7",bdict),'is possible zip codes but with two but not succesive hyphens')
		...
		self.assertEqual(zipcodeFunction("829-456-7",bdict),'is integers separated by hyphen but not zipcode or phone number')

	def test_integer(self):
		regular_expressions("raj567kumar")
		self.assertEqual(integerFunction("raj567kumar",bdict),'is string with integer without spaces')
		regular_expressions("raj 567kumar")
		self.assertEqual(integerFunction("raj 567kumar",bdict),'is string with integer and spaces')
		regular_expressions("raj- 567kumar")
		self.assertEqual(integerFunction("raj- 567kumar",bdict),'is Mixture of string integer and hyphen and spaces')
		regular_expressions("raj-567kumar")
		self.assertEqual(integerFunction("raj-567kumar",bdict),'is Mixture of string integer and hyphen but not spaces')
		regular_expressions("83025")
		self.assertEqual(integerFunction("83025",bdict),'is most probably a zipcode (without hyphen)')		
		regular_expressions("6404")
		self.assertEqual(integerFunction("6404",bdict),'is most probably a zipcode (four digits)')
		regular_expressions("82999")
		self.assertEqual(integerFunction("82999",bdict),'is not a Zipcode')
		regular_expressions("9854")
		self.assertEqual(integerFunction("9854",bdict),'is a four digit integer')
		regular_expressions("82.96")
		self.assertEqual(integerFunction("82.96",bdict),'is Integer with decimals')
		regular_expressions("826")
		self.assertEqual(integerFunction("826",bdict),'is Pure integer')
		regular_expressions("1234567890")
		self.assertEqual(integerFunction("1234567890",bdict),'is 10 digit phone no')
		regular_expressions("+1 123 456 7890")
		self.assertEqual(integerFunction("+1 123 456 7890",bdict),'is phone with four parts containing three spaces and +1')
		regular_expressions("11234567890")
		self.assertEqual(integerFunction("11234567890",bdict),'is 11 digit phone no i.e starts with 1 followed by 10 digits')
		...
		self.assertEqual(integerFunction("-526",bdict),'is Negative integer without decimals')
		regular_expressions("-526.20")
		self.assertEqual(integerFunction("-526.20",bdict),'is Negative integer with decimals')
		regular_expressions("-526.")
		self.assertEqual(integerFunction("-526.",bdict),'is decimal integer with misplaced dot')
		regular_expressions("26*20")
		self.assertEqual(integerFunction("26*20",bdict),'is integer with special characters')
		regular_expressions("26/20")
		self.assertEqual(integerFunction("26/20",bdict),'is integer with special characters')
		regular_expressions("26_20")
		self.assertEqual(integerFunction("26_20",bdict),'is integer with special characters')
		regular_expressions("26?20")
		self.assertEqual(integerFunction("26?20",bdict),'is integer with special characters')
		regular_expressions("-26*20")
		self.assertEqual(integerFunction("-26*20",bdict),'is Negative integer with special characters')
		regular_expressions("-26^20")
		self.assertEqual(integerFunction("-26^20",bdict),'is Negative integer with special characters')
		regular_expressions("-26<20")
		self.assertEqual(integerFunction("-26<20",bdict),'is Negative integer with special characters')
		...
		self.assertEqual(integerFunction("-26~20",bdict),'is Negative integer with special characters')
		regular_expressions("26@20")
		self.assertEqual(integerFunction("26@20",bdict),'is integer with @')

	def test_statecode(self):
		regular_expressions("PA")
		self.assertEqual(stateCodeFunction("PA",bdict),'is possible state code')
		regular_expressions("AB")
		self.assertEqual(stateCodeFunction("AB",bdict),'is two lettered uppercase string not state code')
		regular_expressions("pa")
		self.assertEqual(stateCodeFunction("pa",bdict),'is possible state code in lowercase')
		regular_expressions("ab")
		self.assertEqual(stateCodeFunction("ab",bdict),'is two lettered lowercase string not state code')
		regular_expressions("ALASKA")
		self.assertEqual(stateCodeFunction("ALASKA",bdict),'is possible state name in capital letters')
		regular_expressions("alaska")
		self.assertEqual(stateCodeFunction("alaska",bdict),'is possible state name in lowercase')
		regular_expressions("tamilnadu")
		self.assertEqual(stateCodeFunction("tamilnadu",bdict),'is not state name')
		regular_expressions("INDIA")
		self.assertEqual(stateCodeFunction("INDIA",bdict),'is uppercase string')

	def test_empty(self):
		regular_expressions("")
		self.assertEqual(emptyFunction("",bdict),"is empty")
		regular_expressions(" ")
		self.assertEqual(emptyFunction(" ",bdict),"is empty")
	...
	def test_print_functions(self):
		...
		self.assertEqual(print_string_with_symbol_at_but_not_email('xyz.csv',1,2,[['id', 'first_name', 'last_name', 'email', 'country', 'ip_address'], ['1', 'P@aul', 'Matthews', 'pmatthews0@friendfeed.com', 'Indonesia', '235.160.46.28'], ['2', 'Tammy', 'Lane', 'tlane1@typepad.com', 'Russia', '91.226.216.220']]),1)
		self.assertEqual(print_string_with_hashtag_without_space('xyz.csv',1,2,[['id', 'first_name', 'last_name', 'email', 'country', 'ip_address'], ['1', 'Paul', 'Matthews', 'pmatthews0@friendfeed.com', 'Indonesia', '235.160.46.28'], ['2', 'Tam#my', 'Lane', 'tlane1@typepad.com', 'Russia', '91.226.216.220']]),1)
		self.assertEqual(print_integer_with_hashtag_without_space('xyz.csv',0,1,[['id', 'first_name', 'last_name', 'email', 'country', 'ip_address'], ['1#7', 'Paul', 'Matthews', 'pmatthews0@friendfeed.com', 'Indonesia', '235.160.46.28'], ['2#5', 'Tammy', 'Lane', 'tlane1@typepad.com', 'Russia', '91.226.216.220']]),1)
		self.assertEqual(print_string_with_parantheses('xyz.csv',1,2,[['id', 'first_name', 'last_name', 'email', 'country', 'ip_address'], ['1', 'P(aul', 'Matthews', 'pmatthews0@friendfeed.com', 'Indonesia', '235.160.46.28'], ['2', 'Tamm)y', 'Lane', 'tlane1@typepad.com', 'Russia', '91.226.216.220']]),1)
		self.assertEqual(print_integer_with_symbol_at_but_not_email('xyz.csv',0,1,[['id', 'first_name', 'last_name', 'email', 'country', 'ip_address'], ['123@', 'Paul', 'Matthews', 'pmatthews0@friendfeed.com', 'Indonesia', '235.160.46.28'], ['@232', 'Tammy', 'Lane', 'tlane1@typepad.com', 'Russia', '91.226.216.220']]),1)
		self.assertEqual(print_integer_with_symbol_at_and_dot('xyz.csv',0,1,[['id', 'first_name', 'last_name', 'email', 'country', 'ip_address'], ['12.3@', 'Paul', 'Matthews', 'pmatthews0@friendfeed.com', 'Indonesia', '235.160.46.28'], ['@23.2', 'Tammy', 'Lane', 'tlane1@typepad.com', 'Russia', '91.226.216.220']]),1)
		self.assertEqual(print_integer_with_parantheses('xyz.csv',0,1,[['id', 'first_name', 'last_name', 'email', 'country', 'ip_address'], ['1(', 'Paul', 'Matthews', 'pmatthews0@friendfeed.com', 'Indonesia', '235.160.46.28'], ['2)', 'Tammy', 'Lane', 'tlane1@typepad.com', 'Russia', '91.226.216.220']]),1)
	...
	def test_startTool(self):
		self.assertEqual(startTool('mock.csv',0,1),"return from startTool")
