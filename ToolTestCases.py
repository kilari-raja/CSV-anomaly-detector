...
class TestFunctions(unittest.TestCase):
	...
	# 	self.assertEqual(print_integer_entries('xyz.csv',1,2,[['id', 'first_name', 'last_name', 'email', 'country', 'ip_address'], ['1', 'Paul', 'Matthews', 'pmatthews0@friendfeed.com', 'Indonesia', '235.160.46.28'], ['2', 'Tammy', 'Lane', 'tlane1@typepad.com', 'Russia', '91.226.216.220']]),1)
	# 	self.assertEqual(print_integer_only_entries('xyz.csv',1,2,[['id', 'first_name', 'last_name', 'email', 'country', 'ip_address'], ['1', 'Paul', 'Matthews', 'pmatthews0@friendfeed.com', 'Indonesia', '235.160.46.28'], ['2', 'Tammy', 'Lane', 'tlane1@typepad.com', 'Russia', '91.226.216.220']]),1)		
	...
	# 	self.assertEqual(startTool(),"return from startTool")
