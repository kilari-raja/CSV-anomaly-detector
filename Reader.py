...
website_without_www = state_code = pure_uppercase_string = phone_no_two_hyphens\
= phone_no_with_parantheses = phone_no_without_hyphen_or_alphabets =  empty =\
string_with_integer_without_spaces = pure_integer = \
two_letter_uppercase_string_not_state_code = zipcode_with_two_not_successive_hyphens\
...
= print_empty_count = string_dots_no_email_or_website = \
special_characters_print =email_dominant_column= phone_three_parts_two_hyphens\
= phone_three_parts_one_hyphen_one_parantheses=phone_three_parts_plus_one\
=phone_11_digits=phone_10_digits=row_count= else_count = func_count = \
returnPrintFunction = local_count = count = counter = globvar = purestring\
= pureStringWithSpaces = you = integer_with_at =  row_count =0
...
state_code_array = ["AK","AL","AR","AS","AZ","CA","CO","CT","DC","DE","FL","GA"
...
"Texas","Maryland","Louisiana","Missouri","WY","MN","CA","GA","KS","VT","IN",
"PA","AL","NY","FL","OH","TX","MD","LA"]
